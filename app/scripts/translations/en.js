...
ONBOARD_blockchain_content__5   :  'When you see your balance on MyEtherWallet.com or view your transactions on [explorer.easthub.io](https://explorer.easthub.io), you are seeing data on the blockchain, not in our personal systems.',
...
NAV_Crowdsale                   :  'Join the Crowdsale Now',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different ETH node (e.g. `ETH (explorer.easthub.io)` or `ETH (Infura.io)` or `ETH (MyEtherWallet)`) and check again.',
...
HELP_16_Desc_1                  :  'You can use a blockchain explorer like [explorer.easthub.io](https://explorer.easthub.io/). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://explorer.easthub.io/address/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on explorer.easthub.io',
HELP_16_Title                   :  '16) How do I check the balance of my account?',
HELP_17_Desc_1                  :  'This is most likely due to the fact that you are behind a firewall. The API that we use to get the balance and convert said balance is often blocked by firewalls for whatever reason. You will still be able to send transactions, you just need to use a different method to see said balance, like explorer.easthub.io',
